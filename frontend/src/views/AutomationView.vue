          ...
          <div class="rule-summary">
            <span>{{
              t("automation.ruleSummary", {
                trigger: triggerLabel(r.triggerType),
      ...
      <el-card v-if="selected" class="rule-editor" shadow="never">
        ...
        <el-form label-position="top" @submit.prevent="save">
          ...
          <el-form-item
            ...
            :label="t('automation.statusAction')"
          >
            <el-select
              v-model="statusValue"
              style="width: 100%; max-width: 320px"
...
const triggerOptions = computed(() => [
  { value: "afk_detected", label: t("automation.trigger_afk") },
  { value: "friend_joined", label: t("automation.trigger_friend") },
]);

const actionOptions = computed(() => [
  { value: "change_status", label: t("automation.action_change_status") },
]);
