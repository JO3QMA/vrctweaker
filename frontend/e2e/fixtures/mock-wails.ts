  ...
  return `
    (function() {
      ...
      window.go.main.App = {
        ...
        GetMicMuteSyncSettings: () =>
          Promise.resolve({ enabled: false, oscEndpoint: '' }),
        SaveMicMuteSyncSettings: () => Promise.resolve(),
        GetMicMuteSyncStatus: () =>
          Promise.resolve({
            available: true,
            enabled: false,
        ...
        ConnectMicMuteSyncDiscord: () => Promise.resolve(),
